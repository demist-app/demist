...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!ready) return <div className="min-h-dvh" style={{ background: 'var(--bg)' }} />
  ...
  return (
    <>
      ...
      <nav
        ...
        style={{ background: 'color-mix(in srgb, var(--bg) 92%, transparent)', borderBottom: '1px solid var(--border)' }}
      >
        <Link
          href="/dashboard"
