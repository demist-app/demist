        ...
        <div className="space-y-10 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li><span className="text-white font-medium">Term definitions</span>: to define a term we send the flagged term and a short excerpt of surrounding context to OpenAI. From the web app this is a single sentence per term, never full transcripts. Nothing sent for definitions is stored by us. If you&apos;ve set a translation language and downloaded the on-device model, the definition is translated on your device. If you haven&apos;t downloaded it, the same OpenAI request that generates the definition also translates it.</li>
