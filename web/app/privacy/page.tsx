        ...
        <div className="space-y-10 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-3 dark:text-gray-400 text-gray-700">
              <li><span className="dark:text-white text-gray-900 font-medium">Email address</span>: used for authentication via a one-time code, and to contact you if you join the Pro waitlist. We do not send marketing emails. On the desktop app an email is optional — see above.</li>
              <li><span className="dark:text-white text-gray-900 font-medium">Audio recordings</span>: in the web app, microphone audio is captured in short chunks, sent to Groq or OpenAI for transcription, and immediately discarded. In the desktop app audio never leaves your device at all — see the desktop section below. We do not store audio files in either case.</li>
              ...
              <li><span className="dark:text-white text-gray-900 font-medium">Pro waitlist</span>: if you join the waitlist we store your email and which part of the product prompted you, used only to contact you about Pro. You can join without an account.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-3 dark:text-gray-400 text-gray-700">
              ...
              <li><span className="dark:text-white text-gray-900 font-medium">Hugging Face</span>: the desktop app downloads its on-device models from Hugging Face the first time it needs them, and caches them on your computer. These are ordinary file downloads — no lecture audio, transcript or personal data is sent, and nothing is uploaded.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="dark:text-gray-400 text-gray-700 mb-3">
              If you use the Demist desktop app (Windows), transcription, translation, and term detection all run locally on your device using open-source models. Your lecture audio and the text derived from it are never sent to Groq, OpenAI, or any other third party for processing while using the desktop app.
            </p>
            <p className="dark:text-gray-400 text-gray-700 mb-3">
              The models are not shipped inside the app: the first time each is needed it is downloaded from Hugging Face and cached on your computer, so the app does need internet access on first use. After that, processing works offline. The app uses Whisper (MIT licensed), OPUS-MT translation models (Apache 2.0), Qwen (Apache 2.0) and Meta&apos;s Llama models (Llama Community License); license and attribution details ship with the app.
            </p>
            <p className="dark:text-gray-400 text-gray-700">
