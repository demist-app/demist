        ...
        <div className="space-y-10 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-3 dark:text-gray-400 text-gray-700">
              ...
              <li><span className="dark:text-white text-gray-900 font-medium">Resend</span>: sends the emails Demist has to send you, which is your sign-in code and, if you joined it, the Pro waitlist confirmation. Resend receives your email address and the contents of that email, nothing else.</li>
